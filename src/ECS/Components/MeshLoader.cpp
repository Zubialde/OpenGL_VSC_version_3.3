...
MeshLoader::MeshLoader(std::vector<Vertexx> vertices, std::vector<unsigned int> indices)
{
...
void MeshLoader::SetupMesh()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(Vertexx), &vertices[0], GL_STATIC_DRAW);
